...
/*
	...
	static BankController bank = new BankController(new AccountPersistence());
	...
	public void menu_addAccount (AbstractAccount account) throws FileNotFoundException{
		try {
	...
	public void menu_remove(String number ) throws FileNotFoundException{
		try {
